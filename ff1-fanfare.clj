...
(definst saw-wave [freq 440 attack 0.01 sustain 0.21 release 0.1 vol 0.4]
...
(defn play-voices [inst intv & voices]
  (map-indexed #(apply play-chord-at (* intv %1) inst %2) (apply map vector voices)))


;;; (play-voices saw2 1200 [:c :e :g] [:e :r :b] [:g :r :d])


(play-voices saw2 200
